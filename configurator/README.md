...
Browser-based configuration file editor for Muthur Command.

![Supports aarch64 Architecture][aarch64-shield] ![Supports amd64 Architecture][amd64-shield] ![Supports armhf Architecture][armhf-shield] ![Supports armv7 Architecture][armv7-shield] ![Supports i386 Architecture][i386-shield]

![Configurator in the Muthur Command Frontend][screenshot]
...
code/markup languages. YAML files (the default language for Muthur Command
...
- Restart Muthur Command directly with the click of a button. Reloading groups,
  automations, etc. can be done as well. An API password is required.
- Direct links to Muthur Command documentation and icons.
...
[screenshot]: https://github.com/muthur-command/addons/raw/master/configurator/images/screenshot.png
