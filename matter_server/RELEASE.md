...
3. If the minimal supported schema version has changed, set the `muthurcommand` key in `config.yaml` to the minimum version of Muthur Command Core required to install or update the app.
